    ...
    <main>
      ...
      <section id="products" className="section productsSection">
        <div className="sectionHeading">
          ...
          <p>
            Choose your product and continue through our secure
            Stripe checkout.
          </p>
        </div>
      ...
      <section id="faq" className="section faqSection">
        ...
        <div className="faqGrid">
          <div className="faqItem">
            ...
            <p>
              Yes. Payments are processed through Stripe. DropFits
              does not store your complete card information.
            </p>
          </div>
          ...
          <div className="faqItem">
            ...
            <p>
              Current products are designed for GTA V on PS5 unless
              the individual product listing says otherwise.
            </p>
          </div>
